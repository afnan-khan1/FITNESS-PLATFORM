...
function singUp()
{
    if (isset($_POST['singUp'])) {
        ...
        if (empty($email) || empty($passwd) || empty($address) || empty($fname) || empty($lname) || empty($weight) || empty($height)) {
            $_SESSION['message'] = "empty_err";
            post_redirect("signUp.php");
            return;
        }
        ...
        //             $_SESSION['message'] = "photo_upload_err";
        //             post_redirect("signUp.php");
        //             return;
        //         }
        //     } else {
        //         $_SESSION['message'] = "invalid_photo_type";
        //         post_redirect("signUp.php");
        //         return;
        //     }
        // }
        ...
        $query = "INSERT INTO user (email, user_fname, user_lname, user_address, user_password, user_weight, user_height ) 
                  VALUES ('$email', '$fname', '$lname', '$address', '$passwd', '$weight', '$height')";
        $queryStatus = single_query($query);
        ...
        // Redirect based on query status
        if ($queryStatus == "done") {
            post_redirect("index.php");
        } else {
            $_SESSION['message'] = "wentWrong";
