...
<head>
    ...
    <link rel="icon" href="images/water-bottle.gif" type="image/icon type">
...
<div class="form-group">
    <label for="weight" class="col-md-3 control-label">Weight (kg)</label>
    <div class="col-md-9">
        <input type="text" class="form-control" name="weight" placeholder="Weight">
    </div>
</div>
<div class="form-group">
    <label for="height" class="col-md-3 control-label">Height (cm)</label>
    <div class="col-md-9">
